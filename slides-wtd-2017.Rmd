...
|Field                          |Colleague's Work|Own Work|
|:------------------------------|----------------|--------|
|chemistry                      |  90%           | 60%    |
|biology                        |  80%           | 60%    |
...
- <em>Replication</em>, the ability to re-enact the experiment was too
  high a bar.

- Instead, <em>Reproducibility</em>, the ability to reach the same
  conclusions given the same data and computational software.

- Reproducibility requires that any published research make available
